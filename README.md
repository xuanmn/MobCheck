...
|                       | **Fremennik Warband**           | Archer projectile, Seer spell, Berserker axe _(Region-gated)_                                              | Proj: `15` (R), `160` (M)<br>Anim: `10873` (Melee)           |
...
| **Dagannoth Kings**   | **Dagannoth Prime**             | Water Wave magic projectile _(Region-gated to DK Lair)_                                                    | Proj: `162` (M)                                              |
